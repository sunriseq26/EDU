...
namespace Asteroids
{
    internal sealed class GameController : MonoBehaviour
    {
        ...
        private float _bulletMass = 1.0f;
        ...
        private void Start()
        {
            ...
            _bulletGameObject = _gameObjectBuilder.Visual.Name("Bullet").Sprite(_bullet).Physics.Rigidbody2D(_bulletMass)
                .CircleCollider2D().Logic.CodeBullet();
        ...
        private void Shooting()
        {
            ...
            {
                _viewServices.Create(_bulletGameObject);
            ...
            if (_weaponBullets.Length > 0)
            {
                ...
                {
                    bullet.ViewServices = _viewServices;
                    //bullet.OnReturn += DestroyBullet(_viewServices, gameObject);
        ...
        private void DestroyBullet(ViewServices viewServices, GameObject bullet)
        {
            viewServices.Destroy(bullet);
        }
